...
import RiceCostingPage from '../pages/RiceCostingPage.jsx';
...
function Workspace({ user, signOut, busy, error }) {
  ...
  const pages = {
    ...
    expense_dashboard: <ExpenseDashboardPage />, rice_costing: <RiceCostingPage />, daily_expenses: <ExpensesPage />, monthly_expenses: <MonthlyExpensesPage />, staff_salaries: <StaffSalariesPage />, account: <AccountPage user={user} />,
  };
